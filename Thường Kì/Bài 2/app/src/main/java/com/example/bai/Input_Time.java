...
public class Input_Time extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bt_thoat= findViewById(R.id.button_Exit);
        bt_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                else if((Integer.parseInt(et_Time.getText().toString())==0)){
                    Toast.makeText(Input_Time.this,"Thời gian không được bằng 0", Toast.LENGTH_SHORT).show();
                }
                else  if(et_BuocNhay.length()==0){
                    Toast.makeText(Input_Time.this,"Bước nhảy không được rỗng", Toast.LENGTH_SHORT).show();
                }
                else  if((Integer.parseInt(et_BuocNhay.getText().toString())==0)){
                    Toast.makeText(Input_Time.this,"Bước nhảy không được bằng 0", Toast.LENGTH_SHORT).show();
                }
