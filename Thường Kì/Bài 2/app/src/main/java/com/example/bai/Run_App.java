...
public class Run_App extends AppCompatActivity {
    ...
    int manghinhbai[]={
            ...
            R.drawable.sj,R.drawable.sq,R.drawable.sk,R.drawable.b1fv};
    int diemMay1=0;
    int diemMay=0;
    int hoa=0;
    ...
    TextView tvTime;
    int nhay;
    Button btnStart,btnStop,btnTime,btnDatLai;
    ...
    protected void onStart() {
        ...
        btnDatLai=findViewById(R.id.datlai);
        ...
        btnStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(Integer.parseInt(tvTime.getText().toString())==0){
                    ...
                    Timer = new CountDownTimer(Integer.parseInt(tvTime.getText().toString())*1000,nhay*1000) {
                        @Override
                        ...
                        public void onFinish() {
                           ...
                           btnStart.setEnabled(false);
                            ...
                            if (diemMay<diemMay1)
                            {
                                tvTime.setText("Máy 1 thắng");
                            }else if (diemMay>diemMay1)
                            {
                                tvTime.setText("Máy 2 thắng");
                            }
                            else{
                                tvTime.setText("Hai máy hoà");
                            }
                        }
                    }.start();
                    Timer2 = new CountDownTimer(Integer.parseInt(tvTime.getText().toString())*1000,1000) {
        ...
        btnDatLai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                tv_diemMay1.setText("0");
                tv_diemMay2.setText("0");
                tv_hoa.setText("0");
                tvTime.setText("0");
                btnDatLai.setEnabled(false);
                ...
                diemMay=0;
                diemMay1=0;
                tv_KetQua1.setText("Kết quả: ");
                tv_KetQua2.setText("Kết quả: ");

                iv1.setImageResource(manghinhbai[52]);
                iv2.setImageResource(manghinhbai[52]);
                iv3.setImageResource(manghinhbai[52]);
                iv4.setImageResource(manghinhbai[52]);
                iv5.setImageResource(manghinhbai[52]);
                iv6.setImageResource(manghinhbai[52]);
            }
        });
